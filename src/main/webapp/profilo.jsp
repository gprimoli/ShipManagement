        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p>La disattivazione del tuo account &eacute; permanente, per poterlo riattivare bisogna contattare l'assistenza e provvedere al riconoscimento tramite documento.
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Conferma Operazione</h5>
