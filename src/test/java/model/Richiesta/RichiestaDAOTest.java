...
class RichiestaDAOTest {
    private static Richiesta getRichiesta() {
        ...
        try {
            r = Richiesta.builder()
                    .codFiscaleUtente("LLLGNR99R27F839Q")
                    .tipoCarico("Container")
                    .quantita(120)
                    .dataPartenza(new Date(new SimpleDateFormat("yyyy-MM-dd").parse("2021-08-12").getTime()))
                    .portoPartenza("A")
                    .dataArrivo(new Date(new SimpleDateFormat("yyyy-MM-dd").parse("2022-01-18").getTime()))
                    .portoArrivo("B")
                    .stato("Disponibile")
                    .caricato(false)
                    .build();
    ...
    public static Utente getUtente() {
        ...
        try {
            u = Utente.builder()
                    .codFiscale("LLLGNR99R27F839Q")
                    .nome("pippo")
                    .cognome("doc")
                    .dataNascita(new Date(new SimpleDateFormat("yyyy-MM-dd").parse("1993-08-10").getTime()))
